      ...
      <ul class="list-unstyled">
        ...
        <li class="active"><a href="#ModelViewer" aria-expanded="false" data-toggle="collapse"> <i class="icon-windows"></i>3D Model </a>
          <ul id="ModelViewer" class="collapse list-unstyled ">
            ...
            <li class="active"><a href="autopsy_admin.php">Autopsy</a></li>
          </ul>
        </li>
    ...
    <div class="page-content">
      ...
      <div class="page-header no-margin-bottom">
        <div class="container-fluid">
          <h2 class="h5 no-margin-bottom">3D Model of the Autopsy</h2>
        </div>
      </div>
      <!-- Breadcrumb-->
      <div class="container-fluid">
        <ul class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Autopsy</li>
        </ul>
      </div>
      <!-- 3d Model Container -->
      <section class="no-padding-top">
        <babylon extends="default" templates.viewer.params.enable-drag-and-drop="true">
          <model url="https://models.babylonjs.com/Dude/dude.babylon">
          </model>
          <camera>
            <behaviors>
