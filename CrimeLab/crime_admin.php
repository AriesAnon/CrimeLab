...
<body>
  ...
  <div class="d-flex align-items-stretch">
      ...
      <ul class="list-unstyled">
        ...
        <li class="active"><a href="#crimeManage" aria-expanded="false" data-toggle="collapse"> <i class="icon-padnote"></i> Crime Management </a>
          <ul id="crimeManage" class="collapse list-unstyled ">
            <li class="active"><a href="crime_admin.php">Crime</a></li>
    ...
    <div class="page-content">
      ...
      $results = mysqli_query($db, "SELECT * FROM crime");
      ?>
                    ...
                    <?php while ($row = mysqli_fetch_array($results)) { ?>
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <a href="addcrime.php?del=<?php echo $row['crimeId']; ?>" onclick="return confirm('Are you sure you want to delete this data?');" class="del_btn">DELETE</a>
                          </td>
                          <td>
