...
<body>
  ...
  <div class="d-flex align-items-stretch">
    ...
    <div class="page-content">
            ...
            <div class="col-md-3 col-sm-6">
              <div class="statistic-block block">
                <div class="progress-details d-flex align-items-end justify-content-between">
                  ...
                  $status = "open";
                  $query = "SELECT count(*) as total FROM crime WHERE status='$status' AND id='$id'";
            ...
            <div class="col-md-3 col-sm-6">
              <div class="statistic-block block">
                <div class="progress-details d-flex align-items-end justify-content-between">
                  ...
                  $db = mysqli_select_db($connection, 'crimelab');
                  $status = "open";
                  $query = "SELECT count(*) as total FROM crime WHERE id='$id'";
                  $query_run = mysqli_query($connection, $query);
      ...
      $results = mysqli_query($db, "SELECT * FROM crime WHERE NOT status ='Closed' AND id='$id'");
      ?>
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-lg-12">
              ...
              <div class="title"></br><h2><strong>Your Cases</strong></h2></br></div>
